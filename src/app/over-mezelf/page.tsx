            ...
            <div className='w-full tracking-tight flex flex-col text-left medium:text-center  xlarge:w-full'>
                ...
                <div className='mt-12 large:mt-14 w-full  gap-12 large:gap-0 flex flex-col large:flex-row large:justify-between'>
                    <AnimatedWhenVisible delay={0.10}>
                        <div className="relative w-full max-h-[400px] h-[400px] medium:max-h-[500px] medium:h-[500px] medium:w-3/5 medium:mx-auto large:mx-0 large:aspect-[350/400] large:w-auto large:h-[400px] bg-blue-500 rounded-[20px]">
                            {/*  image */}
                        </div>
                    </AnimatedWhenVisible>
                    <AnimatedWhenVisible className="w-full text-left large:max-w-[60%]" delay={0.2}>
                        <p className='font-medium text-secondary text-base medium:text-[17px] '>
                ...
                <div className='relative  pt-24 flex flex-col gap-12 large:gap-14'>
                    <AnimatedWhenVisible>
                        ...
                        <p className='text-left my-8 text-secondary text-base medium:text-[17px]'>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                        </p>

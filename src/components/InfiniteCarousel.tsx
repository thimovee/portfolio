...
const InfiniteCarousel: FC<InfiniteCarouselProps> = ({ icons, hasBackground }) => {
    ...
    }, [xTranslate, width, duration, rerender, mustFinish]);

    return (
        <div className={cn("h-[115px]  rounded-xl w-full", hasBackground ? "bg-[#101010]" : "")}>
            <motion.div

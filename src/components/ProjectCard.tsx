    ...
    return (
        <Link
            ...
            <motion.div
                ...
                className="absolute w-full h-full bg-gradient-to-t from-black/60 via-neutral-950/5 group-hover:from-black/70 group-hover:via-black/70 group-hover:to-black/70 to-black rounded-2xl" />
            <div className="w-full h-full md:px-5 md:pb-5  items-start flex flex-col">
                <div className="group-hover:opacity-0 group-hover:select-none w-full flex flex-col gap-0 md:gap-2 items-start -translate-y-20 md:-translate-y-0 md:mt-auto">
